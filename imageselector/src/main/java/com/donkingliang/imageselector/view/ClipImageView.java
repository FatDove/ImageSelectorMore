...
public class ClipImageView extends AppCompatImageView {
    ...
    private Paint mFrontGroundPaint2 = new Paint();
...
//        mFrontGroundPaint2.setColor(Color.parseColor("#4490C229"));
//        mFrontGroundPaint.setColor(Color.parseColor("#90C229"));
        mFrontGroundPaint.setAntiAlias(true);
//        mFrontGroundPaint2.setAntiAlias(true);
...
//                | Canvas.CLIP_TO_LAYER_SAVE_FLAG | Canvas.ALL_SAVE_FLAG);
        int sc = canvas.saveLayer(rf,mFrontGroundPaint);
//        int sc = canvas.save();
        //画入矩形黑色半透明蒙板层
